...
router.post('/whatsapp', verifyWebhookOrigin, verifyWebhookHmac, validateWebhookPayload, handleWebhook);

// Also support root path for backward compatibility
// This allows webhook URL to be configured without /whatsapp suffix
router.get('/', verifyWebhook);
router.post('/', verifyWebhookOrigin, verifyWebhookHmac, validateWebhookPayload, handleWebhook);
